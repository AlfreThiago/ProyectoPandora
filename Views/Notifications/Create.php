    ...
    <div class="panel-body">
      ...
      <form method="POST" action="">
        ...
        <div class="perfil-campo" id="userField" style="display:none;">
          <label>Usuario</label>
          <input type="text" id="userSearch" placeholder="Buscar por nombre o email" class="asignar-input asignar-input--small" oninput="filterUsers()" />
          <select name="target_user_id" id="userSelect" class="asignar-input" size="6" style="max-width:480px;">
