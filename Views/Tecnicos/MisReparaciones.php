                            ...
                            <div class="device-card">
                                ...
                                <div class="device-info u-flex-col u-flex-1">
                                    ...
                                    <p class="line-clamp-3">
                                        <strong>Descripción:</strong> <?= htmlspecialchars($ticket['descripcion_falla']) ?>
                                    </p>
                                    
                                    <p>
                                        <strong>Estado:</strong>
                                        <span class="estado <?= strtolower(str_replace(' ', '-', $ticket['estado'])) ?>">
                                    ...
                                    <p>
                                        <strong>Fecha:</strong>
                                        <time title="<?= htmlspecialchars(DateHelper::exact($ticket['fecha_creacion'] ?? '')) ?>">
                                            <?= htmlspecialchars(DateHelper::smart($ticket['fecha_creacion'] ?? '')) ?>
                                        </time>
                                    </p>
                                    
                                    <div class="card-actions">
                                        <a href="/ProyectoPandora/Public/index.php?route=Ticket/Ver&id=<?= $ticket['id'] ?>" class="btn btn-primary">
                                            Ver detalle
                                        </a>
                                    </div>
                                </div>
